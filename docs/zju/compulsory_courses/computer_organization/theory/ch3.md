...
???+ example "例题 课本 3.5 - sign-magnitude"
    ...
    ??? success "答案"
        ...
        $$
        \begin{aligned}
            \text{ } & 00\_011\_110\_101 \\
            + & 11\_100\_001\_010 \\
            — & ———————— \\
            \text{ } & 11\_111\_111\_111
        \end{aligned}
        $$
...
???+ question "课本 3.7 - sign-magnitude"
    ...
    ??? success "答案"
        ...
        $$
        \begin{aligned}
            \text{ } & \dot{0} \dot{1} \dot{1}\_ \dot{1} \dot{0}01\\
            - & 111\_1010\\
            — & ————— \\
            \text{ } & 011\_1111
        \end{aligned}
